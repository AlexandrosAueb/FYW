...
<body class="g-sidenav-show  bg-gray-200">
    <aside
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link text-white  active bg-gradient-primary" href="../pages/map-delivery.jsp">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <iframe src="https://www.google.com/maps/d/u/0/embed?mid=1CQCsAV00BsQKv9EY1pAABDckEVK-YEI&ehbc=2E312F"
